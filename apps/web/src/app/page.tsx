import { BookOpen, Brain, Sparkles, Upload } from "lucide-react";
...
export default async function Home() {
  if (await isAuthenticated()) redirect("/library");
      ...
      <div className="relative flex flex-col items-center justify-center gap-8 px-4 py-24 text-center md:py-32">
        ...
        <div className="max-w-2xl">
          ...
          <p className="mx-auto mt-4 max-w-lg text-lg text-muted-foreground md:text-xl">
            Transform your saved content into a scrollable feed of bite-sized learning cards — like
            social media, but built from your own knowledge.
          </p>
        </div>
