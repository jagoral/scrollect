...
**Project convention for this repo:** Skills live in `.agents/skills/<skill-name>/` with a symlink at `.claude/skills/<skill-name>` pointing to `../../.agents/skills/<skill-name>`. After creating the skill directory and SKILL.md in `.agents/skills/`, create the symlink:
